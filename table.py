'''
write a python function called make_table that takes in a integer
and displays a multiplication table of that size
e.g.
...
#			row = row +' '+ str(left_operand * right_operand) +' '
